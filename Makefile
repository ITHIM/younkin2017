younkin2017.pdf: ./younkin2017.Rnw ./lib/ITHIM.bib ./lib/materialsAndMethods.Rnw ./lib/abstract.Rnw ./lib/introduction.Rnw ./lib/portland.Rnw ./lib/results.Rnw ./lib/ATUS.Rnw ./lib/health.Rnw ./lib/burden.Rnw ./lib/appendix.Rnw ./lib/ITHIM.bib
