...
$B_0$ is the overall burden at baseline. Estimates of the age-sex-cause-specific number of deaths
were obtained from the Oregon Health Authority's Vital Statistics Records averaged for the years 2011-2015 \cite{}.
Burden estimates for Years-of-Life-Lost (YLL) and Years-Lost-to-Disability (YLD) were calculated
using median age for each range and the country-specific life expectancy according the World Health Organization
