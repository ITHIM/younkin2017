...
reported zero active travel time.  In Figure \ref{inactiveMSA} we show
esimates for the proportion of people who have taken zero, less than
five, or more than five walk or bike trips in the last week.

We used questions L3 and L4 of Table 1 of the 2009 National Household
...
at all, for travel or otherwise.  Due to the large proportion of
inactive travelers in U.S. metropolitan areas we model the
distribution of travel activity in terms of \METhrs{} as a mixture of
