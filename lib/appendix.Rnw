...
\begin{table}
    \begin{tabular}{cl}
      ...
      $\muTA$ & mean of log travel activity (among active travelers) \\
      $\sdTA$ & standard deviation of log of travel activity (among active travelers) \\
      $\muLA$ & mean of log of leisure activity \\
      $\muLA$ & standard deviation of log of leisure activity\\
  \end{tabular}
  \caption{Table of parameters used to define the baseline and
    scenario physical activity distribution}
  \label{pSet}
  \end{table}
