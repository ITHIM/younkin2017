...
Given the constraints and complexity of local governance, infrastructure investments, land use, and human behavior there is a
need for high quality and reliable data and tools for decision-making
related to urban transportaiton systems. The lack of accurate estimates of the health impacts of such decisions limits the effectiveness of efforts to encourage non-motorized
