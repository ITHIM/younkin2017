Similar to previous implementations of ITHIM, baseline disease burden 
were procured from state vital records data. Estimates 
of the age-sex-disease-specific number
...
Guidelines. The final metric of disease burden,
